...
class CRUDAdministrador(CRUDBase[Administrador, AdministradorCreate, AdministradorUpdate]):
    ...
    def search_administradores(self, db: Session, *, search_params: AdministradorSearch) -> Tuple[List[Administrador], int]:
    ...
    def update_profile(self, db: Session, *, admin_id: int, profile_data: AdministradorUpdate) -> Optional[Administrador]:
